...
(function (global, factory) {
    ...
    var INIT_MODE_AUTO = '[init-mode="auto"]'
    var INIT_MODE_CUSTOM = '[init-mode="custom"]'
    /**
     * --------------------------------------------
    ...
    var IFrame = /*#__PURE__*/function () {
        ...
        _proto.toggleFullscreen = function toggleFullscreen() {
            if ($__default["default"]('body').hasClass(CLASS_NAME_FULLSCREEN_MODE)) {
                $__default["default"](SELECTOR_DATA_TOGGLE_FULLSCREEN + " i").removeClass(this._config.iconMinimize)
        ...
        IFrame._jQueryInterface = function _jQueryInterface(config) {
            if ($__default["default"](SELECTOR_DATA_TOGGLE$1).length > 0) {
                ...
                new IFrame($__default["default"](this), JSON.parse(localStorage.getItem('AdminLTE:IFrame:Options')))
                    ._initFrameElement();
            }
        };
    ...
    $__default["default"](window).on('load', function () {
        let $init_mode_auto = $__default["default"](INIT_MODE_AUTO)
        if($init_mode_auto.length==0){
            return
        }
        console.log('auto init iframe,you does not custom it by jquery again.')
